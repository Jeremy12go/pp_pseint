...
public class Salida extends Figura{
    ...
    public static void dibujo(double posY ,Canvas canvas, Figura figura, AnchorPane panel_Diagrama){
        ...
        dibujar_flecha(canvas, vertices.get(1).getX()-25, vertices.get(1).getY()+20, 45,10);
        ...
        canvas.setOnMouseClicked(event -> {
            ...
            if (VG.getClickCount() == 2) {
                ...
                VG.setClickCount(0);
                edición(posY,canvas,figura,panel_Diagrama);
            } else {
    ...
    public static void edición(double posY,Canvas canvas, Figura figura, AnchorPane panel_Diagrama){

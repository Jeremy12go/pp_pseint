...
public class Condicional extends Figura{
    ...
    public Condicional(String contenido, Vertice vertice_direccion, Vertice vertice_conexion, Arista dimension, ArrayList<String> contenido_validado, int numero_identificador) {
